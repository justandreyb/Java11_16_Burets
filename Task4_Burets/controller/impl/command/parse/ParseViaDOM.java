...
import by.training.xml_validator.controller.impl.CommandProvider;
...
public class ParseViaDOM implements ParseCommand {
    private static final Logger log = Logger.getLogger(ParseViaDOM.class.getName());
    ...
    public WebXML parse(String request) {
        ...
        try {
            ...
            Parser parser = factory.getParser(ParserName.DOM);
            ...
            log.log(Level.SEVERE, "Error while parsing via DOM", e);
        }
        return webXML;
    }
}
